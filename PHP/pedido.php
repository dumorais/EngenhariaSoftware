...
c = $_POST['Endereco_Retirada'];
$Ende_entr = $_POST['Endereco_Entrega'];
$Pagamento = $_POST['Pagamento'];
$date = date("Y-m-d h:i:s");


$sql = "INSERT INTO `pedido` (`status`, `valor`, `id_cliente`, `id_pagamento`, `emitido`, `id_endereco`, `endereco_retirada`) VALUES ('Procurando Entregador','10',$_SESSION['id_cliente'], $Pagamento, $date, $Ende_entr, $Ende_entr )";
