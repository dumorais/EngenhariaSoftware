...
$sql = "INSERT INTO `pedido` (`status`, `valor`, `id_cliente`, `id_pagamento`, `emitido`, `id_endereco`, `endereco_retirada`) VALUES ('Procurando Entregador','10','" . $_SESSION['id_cliente'] . "', '$Pagamento', '$date', '$Ende_entr', '$Ende_ret')";
